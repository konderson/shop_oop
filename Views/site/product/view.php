    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            <img src="/template/images/product-details/<?php echo $productItem['image'] ?>" alt="" />
                            <h3>ZOOM</h3>
                        </div>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <p>Web ID: <?php echo $productItem['code']?></p>
                            ...
                            <p><b>Наличие:</b><?php if( $productItem['availability']==1){
                                echo "Имеется";
                                }
                                else{
                                    echo "Отсутствует";
                            ...
                            <p><b>Brand:<?php echo $productItem['brand']?></b></p>
                ...
                <div>
                   <h3>Описание</h3>
                    <p style="text-align: center"><?php echo $productItem['description']?></p>
